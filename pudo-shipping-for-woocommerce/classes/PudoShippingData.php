...
class PudoShippingData
{
    ...
    public function buildParcels($data): array
    {
        ...
        } elseif (!empty($data['parcels'])) {
            $parcel = array(
                'submitted_length_cm' => $data['parcels'][0]['dim1'] ?? self::STANDARD_PARCEL['submitted_length_cm'],
                'submitted_width_cm'  => $data['parcels'][0]['dim2'] ?? self::STANDARD_PARCEL['submitted_width_cm'],
                'submitted_height_cm' => $data['parcels'][0]['dim3'] ?? self::STANDARD_PARCEL['submitted_height_cm'],
                'submitted_weight_kg' => $data['parcels'][0]['actmass'] ?? self::STANDARD_PARCEL['submitted_weight_kg'],
                'parcel_description'  => $data['parcels'][0]['description'] ??
                                         self::STANDARD_PARCEL['parcel_description'],
            );
        } else {
